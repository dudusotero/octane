...
Editing a hookless component declared beside its caller now hot-updates instead
of reloading the page. Development output keeps those call sites on the generic
component path, so the refresh has a block to rebuild.
